...
public static class ModerationServiceTestsJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="ModerationServiceTests"/> instance to a JSON string.
    /// </summary>
    /// <param name="value">The instance to serialize.</param>
    /// <param name="indented">Whether to format the JSON with indentation.</param>
    /// <returns>A JSON string representation of the instance.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="value"/> is <see langword="null"/>.</exception>
    public static string ToJson(this ModerationServiceTests value, bool indented = false)
    {
    ...
    /// <summary>
    /// Deserializes a JSON string to a <see cref="ModerationServiceTests"/> instance.
    /// </summary>
    ...
    public static ModerationServiceTests? FromJson(string json)
    {
        ...
        return JsonSerializer.Deserialize<ModerationServiceTests>(json, _jsonOptions);
    }
    ...
    public static bool TryFromJson(string json, out ModerationServiceTests? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<ModerationServiceTests>(json, _jsonOptions);
            return true;
        }
        catch (JsonException)
        {
