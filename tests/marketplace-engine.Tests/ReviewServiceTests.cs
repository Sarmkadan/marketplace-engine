...
/// <summary>
/// Unit tests for <see cref="ReviewService"/> functionality.
/// Tests various scenarios including review submission, seller replies, statistics retrieval, and review removal.
/// </summary>
...
/// Sets up mock repositories and creates the service under test.
/// </summary>
...
[Fact]
/// <summary>
/// Tests that <see cref="ReviewService.SubmitReviewAsync"/> throws <see cref="ResourceNotFoundException"/> when the reviewer is not found.
/// </summary>
...
[Fact]
/// <summary>
/// Tests that <see cref="ReviewService.SubmitReviewAsync"/> throws <see cref="UnauthorizedException"/> when the reviewer is inactive.
/// </summary>
...
[Fact]
/// <summary>
/// Tests that <see cref="ReviewService.SubmitReviewAsync"/> throws <see cref="MarketplaceException"/> when the reviewer attempts to review themselves.
/// </summary>
...
[Fact]
/// <summary>
/// Tests that <see cref="ReviewService.SubmitReviewAsync"/> throws <see cref="DuplicateResourceException"/> when attempting to submit a duplicate review.
/// </summary>
...
[Fact]
/// <summary>
/// Tests that <see cref="ReviewService.SubmitReviewAsync"/> successfully creates a review and updates seller rating with valid data.
...
[Fact]
/// <summary>
/// Tests that <see cref="ReviewService.AddSellerReplyAsync"/> throws <see cref="UnauthorizedException"/> when the caller is not the seller.
/// </summary>
...
[Fact]
/// <summary>
/// Tests that <see cref="ReviewService.GetSellerStatsAsync"/> returns correct average rating and review distribution.
/// <returns>A tuple containing the average rating, total review count, and score distribution dictionary.</returns>
/// </summary>
...
[Fact]
/// <summary>
/// Tests that <see cref="ReviewService.RemoveReviewAsync"/> throws <see cref="UnauthorizedException"/> when the caller is not a moderator.
/// </summary>
