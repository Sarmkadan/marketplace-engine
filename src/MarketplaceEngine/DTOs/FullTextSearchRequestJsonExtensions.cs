...
/// <summary>
/// Provides System.Text.Json serialization helpers for <see cref="FullTextSearchRequest"/>.
/// </summary>
public static class FullTextSearchRequestJsonExtensions
{
    ...
    /// <summary>
    /// Serializes a <see cref="FullTextSearchRequest"/> instance to a JSON string.
    /// </summary>
    ...
    public static bool TryFromJson(string json, out FullTextSearchRequest? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<FullTextSearchRequest>(json, _options);
            return true;
        }
        catch (JsonException)
        {
