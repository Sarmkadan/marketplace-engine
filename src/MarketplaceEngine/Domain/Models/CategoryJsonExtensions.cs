...
/// <summary>
/// Provides System.Text.Json serialization extensions for <see cref="Category"/> type.
/// </summary>
public static class CategoryJsonExtensions
{
  ...
  private static bool TryFromJsonCore(string json, out Category? value)
  {
    value = null;
